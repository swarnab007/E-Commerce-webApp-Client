    ...
    <Layout title="About us" description="About us page">
      <div className="text-center">
        <div className="mx-auto max-w-7xl px-4">
          ...
          {/* TEAM */}
          <div className="grid grid-cols-1 gap-6 gap-y-6 border-b border-gray-300 py-12 pb-20 md:grid-cols-2 lg:grid-cols-4">
            {users.map((user) => (
              <div className="rounded-md" key={user.name}>
                <img
                  src={user.image}
                  alt={user.name}
                  className="h-[300px] w-full rounded-full object-cover mx-auto"
                />
                <p className="mt-6 w-full px-2 text-xl font-bold text-gray-900">
                  {user.name}
                </p>
                <p className="w-full mt-4 px-2 pb-6 text-lg font-bold text-gray-500">
                  {user.position}
                </p>
              </div>
            ))}
